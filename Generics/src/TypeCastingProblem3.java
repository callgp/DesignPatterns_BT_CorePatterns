...
public class TypeCastingProblem3 {
	...
	public static void main(String[] args) {
		...
		List<String> l=new ArrayList<String>();//type safety and type cating problems avoided...parameters cannot have polymorphism like lhs <> has object rhs <> has string not possible..also cannot use primitives primitieves
		l.add("xyz");
		l.add("rr");
