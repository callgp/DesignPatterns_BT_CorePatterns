...
public class OddNumberWithBreakInsteadOfContiniue {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<10;i++){
			if(i%2==0){
				break;//if put break it will break whole for loop not just current iteration
				//for even numbers it wil continue to for loop directly for next number without going to below sysout
